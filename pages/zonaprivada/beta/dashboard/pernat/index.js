...
// Import Components...
import Menu from '../../../../../components/pernat/sideMenu/menu-pernat'
import FooterSection from '../../../../../components/pernat/footer/footerPernat';
import Header from '../../../../../components/pernat/header/header-pernat'
...
//   const { auth } = useContext(PernatContext)
...
useEffect(()=> {
  if(localStorage.getItem('tasaRol') != '3' ){
