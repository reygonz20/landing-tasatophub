            ...
            <section id="iq-home" className="iq-banner-03 overview-block-pt blue-bg" style={{backgroundColor:'#146cae', marginTop: '0px', marginBottom: '4%'}}>
                <div className="container" style={{marginTop: '0px'}}>
                    <div className="banner-text text-left" style={{marginTop: '0px'}}>
                        <div className="row justify-content-between" style={esCliente ? {marginTop: '1%'} : {}}>
                            <div className="col-md-6 align-self-center" style={{marginTop: '0px'}}>
                                <h1 className="iq-font-white iq-tw-4" style={{marginTop: '1%'}}>¡Registra tus datos para crear tu cuenta!</h1>
                                <h5 className="iq-font-white iq-mtb-20" style={{marginTop: '1%'}}>¿Ya tienes cuenta?</h5>
                                
                                    <a href="/zonaprivada/iniciar-sesion"  className="button bt-red iq-mt-15 iq-mb-30">Inicia Sesión</a>
                            </div>
                            

                            <Formulario esCliente={false} cambioEsCliente={cambioEsCliente} />
