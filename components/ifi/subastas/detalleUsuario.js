...
const detalle = ({detalleFila, setDetalleFila, mobile, dataSelectedRow, selectedRow}) => {
    ...
    const mapDetallesPorAperturar = dataSelectedRow.map((item) => {
        return (
    <React.Fragment>
