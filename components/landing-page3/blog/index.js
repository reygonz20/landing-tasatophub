                                        ...
                                        <div className="iq-blog-box">
                                            ...
                                            <div className="iq-blog-detail">
                                                ...
                                                <div className="blog-content">
                                                    <p>You may need to share a piece of data with all views that are rendered by your application with single format. </p>
                                                </div>
                                    ...
                                    <div className="item">
                                        <div className="iq-blog-box">
                                            ...
                                            <div className="iq-blog-detail">
                                                <div className="blog-title">
                                                    <a href="#">
                                                        <h5 className="iq-tw-7 iq-mb-10">Passing Data in React</h5>
                                                    </a>
                                                </div>
                                                <div className="blog-content">
                                                    <p>You can send data from a child to a parent component by custom props method. you access this data form the props object.</p>
                                                </div>
                                                <div className="iq-blog-meta">
                                                    <ul className="list-inline">
                                                        <li className="list-inline-item">
                                    ...
                                    <div className="item">
                                        <div className="iq-blog-box">
                                            ...
                                            <div className="iq-blog-detail">
                                                <div className="blog-title">
                                                    <a href="#">
                                                        <h5 className="iq-tw-7 iq-mb-10">Learn React ?</h5>
                                                    </a>
                                                </div>
                                                <div className="blog-content">
                                                    <p>React is easier to learn because it leverages more traditional web technologies better than other framework. </p>
                                                </div>
                                                <div className="iq-blog-meta">
                                                    <ul className="list-inline">
                                                        <li className="list-inline-item">
                                                ...
                                                <div className="media-wrapper">
                                                    <div className="iq-bolg-video">
                                                        {/*<iframe src="https://www.youtube.com/embed/nrJtHemSPW4?rel=0"
                                                                allowFullScreen />*/}
                                                        <img className="img-fluid center-block"
                                                             src="/assets/images/blog/04.jpg" alt="#" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="iq-blog-detail">
                                                ...
                                                <div className="blog-content">
                                                    <p>Views contain the HTML served by your application and separate your controller logic from your presentation logic. </p>
                                                </div>
                                                <div className="iq-blog-meta">
                                                    <ul className="list-inline">
                                                        <li className="list-inline-item">
                                    ...
                                    <div className="item">
                                        <div className="iq-blog-box">
                                            ...
                                            <div className="iq-blog-detail">
                                                ...
                                                <div className="blog-content">
                                                    <p>It's easier to learn than AngularJS or React. Part of the ease comes from that you can add Vue to any single webpage file.</p>
                                                </div>
                                                <div className="iq-blog-meta">
                                                    <ul className="list-inline">
                                                        <li className="list-inline-item">
