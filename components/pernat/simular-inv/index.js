...
const SimuInvPernat = ({pernat, setPernat}) => {
  ...
  <div className="row">
      ...
      <form method="post" id="compare" action="/depositos-plazo/result">
        <div className="form-compare row">
          ...
          <div className="form-item col-lg-4" style={{}}>
          ...
          <div className="form-item col-lg-6" style={{marginTop: '20px'}}>
            ...
            <div id="geo-container" className="select-container select-input action-select">
              <div className="dropdown bootstrap-select required"><select name="geo" id="geo" style={{borderColor: 'white', color: '#e01e2b'}} className="selectpicker required" data-container="body" title="Selecciona"><option className="bs-title-option" value="LI">Mostrar todo</option>
