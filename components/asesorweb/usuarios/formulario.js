...
placeholder="Contraseña*" name="pass" required style={{ borderColor: '#e01e2b', height: '40px'}}
// onChange={(event)=>this.inputChangedHandler(event)}
/>
</div>
</div>
...
<div className="label" style={{marginBottom: '10px'}}><span className="form-label" style={{color: 'black', fontSize: '0.8rem', fontWeight: '600'}}>Género:</span></div>
...
<div className="form-item col-lg-4">
<div className="label" style={{marginBottom: '10px'}}><span className="form-label" style={{color: 'black', fontSize: '0.8rem', fontWeight: '600'}}>Institución Financiera:</span></div>
<div  className="select-container select-input action-select">
<div className="dropdown bootstrap-select required">
